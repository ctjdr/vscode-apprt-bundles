...
* **[Component implementation](#component-implementation)** - From the manifest.json, jump to a component's implementation with a single click on a code lens.
* **[Go to bundle keybinding](#go-to-bundle-keybinding)** - Get to the bundle selection list with a n easy-to-memorize keyboard shortcut
